...
(cl:defclass <motor> (roslisp-msg-protocol:ros-message)
  ((motor_freq
    :reader motor_freq
    :initarg :motor_freq
    :type dlut_pc_odom-msg:UInt32
    :initform (cl:make-instance 'dlut_pc_odom-msg:UInt32))
...
(cl:defmethod cl:initialize-instance :after ((m <motor>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'motor)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dlut_pc_odom-msg:<motor> is deprecated: use dlut_pc_odom-msg:motor instead.")))

(cl:ensure-generic-function 'motor_freq-val :lambda-list '(m))
(cl:defmethod motor_freq-val ((m <motor>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dlut_pc_odom-msg:motor_freq-val is deprecated.  Use dlut_pc_odom-msg:motor_freq instead.")
  (motor_freq m))

(cl:ensure-generic-function 'num_of_pulse_per_circle-val :lambda-list '(m))
(cl:defmethod num_of_pulse_per_circle-val ((m <motor>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dlut_pc_odom-msg:num_of_pulse_per_circle-val is deprecated.  Use dlut_pc_odom-msg:num_of_pulse_per_circle instead.")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<motor>)))
  ...
  (cl:format cl:nil "UInt32 motor_freq         #the frequency we send the pulse to the motor~%UInt32 num_of_pulse_per_circle	#the number of the pulse a circle of sick~%~%================================================================================~%MSG: dlut_pc_odom/UInt32~%uint32 data~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'motor)))
  "Returns full string definition for message of type 'motor"
  (cl:format cl:nil "UInt32 motor_freq         #the frequency we send the pulse to the motor~%UInt32 num_of_pulse_per_circle	#the number of the pulse a circle of sick~%~%================================================================================~%MSG: dlut_pc_odom/UInt32~%uint32 data~%~%"))
