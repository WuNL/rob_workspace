...
(cl:defmethod cl:initialize-instance :after ((m <UInt32>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'UInt32)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dlut_pc_odom-msg:<UInt32> is deprecated: use dlut_pc_odom-msg:UInt32 instead.")))

(cl:ensure-generic-function 'data-val :lambda-list '(m))
(cl:defmethod data-val ((m <UInt32>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dlut_pc_odom-msg:data-val is deprecated.  Use dlut_pc_odom-msg:data instead.")
  (data m))
