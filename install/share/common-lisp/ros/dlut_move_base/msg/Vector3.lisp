...
(cl:defmethod cl:initialize-instance :after ((m <Vector3>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Vector3)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dlut_move_base-msg:<Vector3> is deprecated: use dlut_move_base-msg:Vector3 instead.")))
...
(cl:defmethod z-val ((m <Vector3>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dlut_move_base-msg:z-val is deprecated.  Use dlut_move_base-msg:z instead.")
  (z m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Vector3>)))
  ...
  (cl:format cl:nil "# This represents a vector in free space. ~%~%float64 x~%float64 y~%float64 z~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Vector3)))
  "Returns full string definition for message of type 'Vector3"
  (cl:format cl:nil "# This represents a vector in free space. ~%~%float64 x~%float64 y~%float64 z~%~%~%"))
